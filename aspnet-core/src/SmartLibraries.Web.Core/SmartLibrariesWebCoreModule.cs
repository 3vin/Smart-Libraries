...
namespace SmartLibraries
{
    ...
    public class SmartLibrariesWebCoreModule : AbpModule
    {
        ...
        public SmartLibrariesWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(SmartLibrariesApplicationModule).GetAssembly()
                 );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SmartLibrariesWebCoreModule).GetAssembly());
        }
    }
}
